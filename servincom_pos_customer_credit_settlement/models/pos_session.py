...
class PosSession(models.Model):
    ...
    def get_closing_control_data(self):
        ...
        cash_method_id = (data.get("default_cash_details") or {}).get("id")
        ...
        for payment_method in non_cash_payments.mapped("payment_method_id"):
            ...
            if payment_method.id in method_rows:
                method_rows[payment_method.id]["amount"] += amount
                method_rows[payment_method.id]["number"] += len(method_payments)
                continue
            method_data = {
            ...
            method_rows[payment_method.id] = method_data
